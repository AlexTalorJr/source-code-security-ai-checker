...
- **8 сканеров безопасности с автоопределением** -- сканеры активируются автоматически на основе языков проекта
- **Поддержка множества языков** -- Python, PHP/Laravel, C/C++, JavaScript/TypeScript, Go, Rust, Java, C#, Ruby
